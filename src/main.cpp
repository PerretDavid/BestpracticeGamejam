...
// configuration step. It creates a namespace called `BestpracticeGamejam`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        BestpracticeGamejam::cmake::project_name,
        BestpracticeGamejam::cmake::project_version));// version string, acquired
